...
import com.orange.services.FIPEService;
import com.orange.services.VehicleService;
...
public class VehicleResources {
	...
	@Autowired FIPEService fipeService;
	...
	@GetMapping(value = "/fipe")
	public ResponseEntity<Object> getValue() {
	
		return ResponseEntity.ok().body(fipeService.getValue());
	}
